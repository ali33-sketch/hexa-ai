...
export default function Home() {
  ...
  function sendMessage(event?: FormEvent) {
    ...
    if (!value) return;
    setMessages((current) => [...current, { role: "user", text: value }, { role: "assistant", text: "I’m ready to help with that. Connect an AI provider to enable Hexa’s full agent capabilities." }]);
    setInput("");
  }
